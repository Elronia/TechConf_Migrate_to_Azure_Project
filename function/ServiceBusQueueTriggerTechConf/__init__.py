...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="Elronia@postgresql-server-techconf", password="Easy12345!", host="postgresql-server-techconf.postgres.database.azure.com")
